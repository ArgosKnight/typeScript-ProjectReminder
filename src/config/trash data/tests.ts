...
//     next(err);
//   }
//// agregamos las condiones de mostrar:
// try {
...
//   //   const newStatus = isActive === undefined ? false : Boolean(isActive);
//   //   const updatedProduct = await Product.findByIdAndUpdate(
//   //     productId,
//   //     { isActive: newStatus },
//   //   ).exec();
...
//   //     res.status(400).send({ message: 'El valor del estado debe ser un booleano.' });
//   //     return;
//   //   }
